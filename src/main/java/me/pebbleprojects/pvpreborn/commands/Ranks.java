    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        new Thread(() -> {
            if (sender instanceof Player) {
                ...
                player.sendMessage("§eAvailable Ranks");
                player.sendMessage("§5LEGENDARY §8» §e17,500 §bPoints");

                final TextComponent component = new net.md_5.bungee.api.chat.TextComponent("§5Amethyst §8» §e15,000 -> 17,000 §bPoints");
                ...
                component.setText("§4Ultimate §8» §e12,500 -> 14,500 §bPoints");
                ...
                component.setText("§3Special §8» §e10,000 -> 12,000 §bPoints");
                ...
                component.setText("§8Iron §8» §e7,500 -> 9,500 §bPoints");
                ...
                component.setText("§8Silver §8» §e5,000 -> 7,000 §bPoints");
                ...
                component.setText("§6Bronze §8» §e1,500 -> 4,500 §bPoints");
