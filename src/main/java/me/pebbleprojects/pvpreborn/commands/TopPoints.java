...
public class TopPoints implements CommandExecutor {

    private final Handler handler;

    public TopPoints(final Handler handler) {
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        new Thread(() -> {
            ...
            list.sort(Comparator.comparingInt(uuid -> handler.playerDataHandler.getPoints((UUID) uuid)));
